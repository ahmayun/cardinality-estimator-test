...
object Q3 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // Define UDF for month filtering
    val monthFilterUDF: UserDefinedFunction = udf((month: Int) => month)
    spark.udf.register("monthFilter", monthFilterUDF)
